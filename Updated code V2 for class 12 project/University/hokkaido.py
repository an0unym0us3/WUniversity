...
hiroshima = ctk.CTk()
hiroshima.title('Hokkaido University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/hokkaido_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Hokkaido University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Sapporo, Japan', font=("Arial", 20))
