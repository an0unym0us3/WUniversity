...
hiroshima = ctk.CTk()
hiroshima.title('Nagoya University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/nagoya_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Nagoya University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Nagoya, Japan', font=("Arial", 20))
