...
hiroshima = ctk.CTk()
hiroshima.title('University of Tsukuba')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/tsukuba_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='University of Tsukuba', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Tsukuba, Japan', font=("Arial", 20))
