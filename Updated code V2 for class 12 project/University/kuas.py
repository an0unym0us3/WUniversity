...
hiroshima = ctk.CTk()
hiroshima.title('Kyoto University of Advanced Science')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/kuas_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Kyoto University of Advanced Science', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Kyoto, Japan', font=("Arial", 20))
    ...
    type = ctk.CTkLabel(second_frame, text='Private', font=("Arial", 20))
