...
hiroshima = ctk.CTk()
hiroshima.title('Sophia University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/sophia_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Sophia University', font=("Arial", 30, "bold"))
