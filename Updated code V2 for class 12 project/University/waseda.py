...
hiroshima = ctk.CTk()
hiroshima.title('Waseda University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/waseda_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Waseda University', font=("Arial", 30, "bold"))
