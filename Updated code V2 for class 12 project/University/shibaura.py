...
hiroshima = ctk.CTk()
hiroshima.title('Shibaura Institute of Technology')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/shibaura_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Shibaura Institute of Technology', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Tokyo, Japan', font=("Arial", 20))
