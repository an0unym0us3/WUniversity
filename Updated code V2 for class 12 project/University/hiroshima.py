...
hiroshima.geometry('1000x1000')
ctk.set_appearance_mode('light')

def open_window():

    main_frame = Frame(hiroshima)
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/hiroshima_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Hiroshima University', font=("Arial", 30, "bold"))
    ...
    pin_label.place(x=250, y=263)
    #pin_label.grid(row=1, column=0, padx=250, pady=20, sticky='w')

    location = ctk.CTkLabel(second_frame, text='Higashihiroshima, Japan', font=("Arial", 20))
    location.grid(row=1, column=1, padx=10, pady=10, sticky="n")
    ...
    #type_label.grid(row=2, column=0, padx=250, pady=20, sticky='w')
    type_label.place(x=250, y=263 + 45)

    type = ctk.CTkLabel(second_frame, text='Public/National', font=("Arial", 20))
    ...
    #ty_label.grid(row=3, column=0, padx=250, pady=20, sticky='w')
    ty_label.place(x=250, y=263 + (48 * 2))
    ...
    rank_no = ctk.CTkLabel(second_frame, text='#20', font=("Arial", 30, "bold"))
    ...
    #dept_label.grid(row=4, column=0, padx=250, pady=20, sticky='w')
    dept_label.place(x=250, y=416)
    ...
    #course_label.grid(row=5, column=0, padx=250, pady=20, sticky='w')
    course_label.place(x=250, y=465)

    course = ctk.CTkLabel(second_frame, text='Course :', font=("Arial", 20, "bold"))
    course.grid(row=5, column=1, padx=10, pady=10, sticky="n")

    course_name = ctk.CTkLabel(second_frame, text='Computer Science', font=("Arial", 20))
    ...
    #fees_label.grid(row=6, column=0, padx=250, pady=20, sticky='w')
    fees_label.place(x=250, y=515)

    fees = ctk.CTkLabel(second_frame, text='Fees :', font=("Arial", 20, "bold"))
    fees.grid(row=6, column=1, padx=10, pady=10, sticky="n")

    fees_name = ctk.CTkLabel(second_frame, text='2000000 yen', font=("Arial", 20))
    ...
    #score_label.grid(row=7, column=0, padx=250, pady=20, sticky='w')
    score_label.place(x=250, y=566)
    ...
    #seats_label.grid(row=12, column=0, padx=250, pady=20, sticky='w')
    seats_label.place(x=250, y=806)
    ...
    #method_label.grid(row=13, column=0, padx=250, pady=20, sticky='w')
    method_label.place(x=250, y=855)
    ...
    #dates_label.grid(row=14, column=0, padx=250, pady=20, sticky='w')
    dates_label.place(x=250, y=903)
    ...
    #essay_label.grid(row=20, column=0, padx=250, pady=20, sticky='w')
    essay_label.place(x=250, y=1200)
    ...
    application = ctk.CTkButton(second_frame, text='Apply', fg_color='#601E88', hover_color='#E44982', 
                    text_color="#ffffff", corner_radius=5, border_color='#ffffff', border_width=0)
