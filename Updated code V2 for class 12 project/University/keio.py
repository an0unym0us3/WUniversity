...
hiroshima = ctk.CTk()
hiroshima.title('Keio University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/keio_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Keio University', font=("Arial", 30, "bold"))
