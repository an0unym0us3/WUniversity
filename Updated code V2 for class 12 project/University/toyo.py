...
hiroshima = ctk.CTk()
hiroshima.title('Toyo University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/toyo_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Toyo University', font=("Arial", 30, "bold"))
