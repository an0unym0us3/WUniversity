...
hiroshima = ctk.CTk()
hiroshima.title('Kyushu University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/kyushu_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Kyushu University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Fukuoka, Japan', font=("Arial", 20))
