...
hiroshima = ctk.CTk()
hiroshima.title('Kobe University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/kobe_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Kobe University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Kobe, Japan', font=("Arial", 20))
