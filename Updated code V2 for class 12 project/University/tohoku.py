...
hiroshima = ctk.CTk()
hiroshima.title('Tohoku University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/tohoku_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Tohoku University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Sendai, Japan', font=("Arial", 20))
