...
hiroshima = ctk.CTk()
hiroshima.title('University of Tokyo')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/tokyo_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='University of Tokyo', font=("Arial", 30, "bold"))
