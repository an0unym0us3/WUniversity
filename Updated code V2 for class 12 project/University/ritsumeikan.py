...
hiroshima = ctk.CTk()
hiroshima.title('Ritsumeikan University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/ritsumeikan_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Ritsumeikan University', font=("Arial", 30, "bold"))
