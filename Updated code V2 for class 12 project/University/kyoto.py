...
hiroshima = ctk.CTk()
hiroshima.title('Kyoto University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/kyoto_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Kyoto University', font=("Arial", 30, "bold"))
