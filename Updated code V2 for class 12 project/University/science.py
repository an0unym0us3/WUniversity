...
hiroshima = ctk.CTk()
hiroshima.title('Institute of Science Tokyo')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/science_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Institute of Science Tokyo', font=("Arial", 30, "bold"))
