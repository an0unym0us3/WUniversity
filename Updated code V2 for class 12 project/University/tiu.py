...
hiroshima = ctk.CTk()
hiroshima.title('Tokyo International University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/tiu_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Tokyo International University', font=("Arial", 30, "bold"))
