...
hiroshima = ctk.CTk()
hiroshima.title('Osaka University')
...
def open_window():
    ...
    bg_image = ctk.CTkImage(Image.open("Campus/osaka_campus.jpg"), size=(1000, 250))
    ...
    title = ctk.CTkLabel(second_frame, text='Osaka University', font=("Arial", 30, "bold"))
    ...
    location = ctk.CTkLabel(second_frame, text='Osaka, Japan', font=("Arial", 20))
