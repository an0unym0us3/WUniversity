...
from fillments_handler import db_personal, db_documents, db_scores, db_uploads
...
def submit_form():
    if validate_upload_documents():
        ...
        """db_personal(first_name_entry.get(),
                    last_name_entry.get(),
                    dob_entry.get(),
                    email_entry.get(),
                    phone_entry.get())"""

        db_documents(passport_entry.get(),
            residence_front_entry.get(),
            residence_back_entry.get(),
            passport_photo_entry.get())

        """db_scores(ielts_var.get(),
                  toefl_var.get(),
                  sat_var.get(),
                  act_var.get())

        db_uploads(transcript_entry.get(),
                   lor1_entry.get(),
                   lor2_entry.get(),
                   statement_entry.get())"""
