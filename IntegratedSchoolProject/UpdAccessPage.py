...
def create_recovery_frame(master):
    ...
    recovery_authentication = CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#601E88",
                                     border_width=1, text_color="#000000", show="*")
    recovery_authentication.pack(anchor="w", padx=(25, 0))
