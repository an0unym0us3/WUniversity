...
from modules import access_handler as ah
...
# Window Icon Photo
icon = PhotoImage(file='images/hyy.png')
...
# ==== Full Name =======
name_entry = Entry(design_frame8, fg="#000000", font=("arial", 13), highlightthickness=2)
...
# ======= Email ===========
email_entry = Entry(design_frame8, fg="#000000", font=("yu gothic ui semibold", 12), highlightthickness=2)
...
# ====== Password =========
password_entry = Entry(design_frame8, fg="#000000", font=("yu gothic ui semibold", 12), show='•', highlightthickness=2)
...
# ====== Confirm Password =============
confirmPassword_entry = Entry(design_frame8, fg="#000000", font=("yu gothic ui semibold", 12), highlightthickness=2)
...
signUp2 = Button(design_frame8, fg='#f8f8f8', text='Sign Up', bg='#1b87d2', font=("yu gothic ui bold", 15),
                 cursor='hand2', activebackground='#1b87d2', command=register)
