...
science = ctk.CTk()
science.title('Institute of Science Tokyo')
ws = science.winfo_screenwidth() 
hs = science.winfo_screenheight() 
w = 1000 
h = 750 
x = (ws/2) - (w/2) 
y = (hs/2) - (h/2) 
science.geometry('%dx%d+%d+%d' % (w, h, x, y))
ctk.set_appearance_mode('light')

def open_window():

    main_frame = Frame(science)
