...
# Application setup
app = CTk()
app.title('Secure Login Portal')
app.geometry("700x600")
app.resizable(False, False)

# Load and set background image
bg_image = CTkImage(Image.open("signin-side-img.png"), size=(700, 600))
...
def on_sign_in():
    ...
    try:
        ...
        signin_username_entry.delete(0, CTk.END)  # Clear entry field
        signin_password_entry.delete(0, CTk.END)  # Clear entry field
